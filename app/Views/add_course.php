    ...
    <div class="container">
        ...
        <form>
            ...
            <select id="department" name="department">
                <option value="">Department of Computing and Information Systems</option>
                <option value="">Department of Software Engineering</option>
                <option value="">Department of Data Science</option>
